...
function tabla_alergia_paciente(cedula_paciente) {
  ...
  var dominio =
    ...
    "sistema/quirofano/estructura/alergias_paciente.php";
  var titulo = localStorage.getItem("titulo");
...
function tabla_antecedentes_familiarC(cedula_paciente) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/estructura/tabla_antecedentes_familiar.php";
  var titulo = localStorage.getItem("titulo");
...
function generar_tbl_medicamento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/estructura/generar_tbl_medicamento.php";
  var titulo = localStorage.getItem("titulo");
...
function guardar_diagnostico() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/php/actualizar_atencion.php";
  var titulo = localStorage.getItem("titulo");
...
function mostrar_tbl_tratamiento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/estructura/tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function guardar_tratamiento() {
  var dominio =
    localStorage.getItem("dominio") + "sistema/quirofano/php/tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function select_Prueba_medica() {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/estructura/select_Prueba_medica.php";
  var titulo = localStorage.getItem("titulo");
  var variable = "";
  $.ajax({
    type: "POST",
...
function eliminar_detalle_tratamiento(id_detalle_tratamiento, id_tratamiento) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/php/eliminar_detalle_tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var variable =
...
function examen() {
  var dominio =
    localStorage.getItem("dominio") + "sistema/quirofano/estructura/examen.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
  var variable = "id_atencion=" + id_atencion;
...
function eliminar_detalle_examen(id_det_examen, id_examen) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/php/eliminar_detalle_examen.php";
  var titulo = localStorage.getItem("titulo");
...
function guardar_examen() {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/php/guardar_examen.php";
  var titulo = localStorage.getItem("titulo");
  var variable =
    "id_atencion=" +
    id_atencion +
...
function Finalizar() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/php/update_atencion.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function select_id_tipo(id_tipo) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano/estructura/select_tipo_atencion.php";
  var titulo = localStorage.getItem("titulo");
