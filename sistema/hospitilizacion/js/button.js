...
function tabla_alergia_paciente(cedula_paciente) {
  ...
  var dominio =
    ...
    "sistema/hospitilizacion/estructura/alergias_paciente.php";
  var titulo = localStorage.getItem("titulo");
  $(".titulo").html("Hospitilizacion-Alergia de paciente seleccionado");
  $.ajax({
    type: "POST",
    url: dominio,
...
function tabla_antecedentes_familiarC(cedula_paciente) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/estructura/tabla_antecedentes_familiar.php";
  var titulo = localStorage.getItem("titulo");
  $(".titulo").html("Hospitilizacion-Antecedentes de paciente seleccionado");
  $.ajax({
    type: "POST",
    url: dominio,
    data: "cedula_paciente=" + cedula_paciente,
...
function formulario_medico(id_atencion) {
  ...
  $.ajax({
    type: "POST",
    url: dominio + "sistema/hospitilizacion/estructura/formulario.php",
...
function generar_tbl_medicamento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/estructura/generar_tbl_medicamento.php";
  var titulo = localStorage.getItem("titulo");
...
function medicamento_seleccionado(id_medicamento, codigo, descripcion, forma) {
  ...
  if (checkBox.checked == true) {
    ...
    text_id_medicamento = input_id_medicamento.replace(
      id_medicamento + ",",
      ""
    );
  }
...
function guardar_diagnostico() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/php/actualizar_atencion.php";
  var titulo = localStorage.getItem("titulo");
...
function mostrar_tbl_tratamiento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/estructura/tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function guardar_tratamiento() {
  var dominio =
    localStorage.getItem("dominio") + "sistema/hospitilizacion/php/tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
  ...
  if (tratamiento === "") {
    alert_bonita("error", titulo, "Ingrese tratamiento");
    return;
  }
  if (estado_tratamiento === "0") {
    alert_bonita("error", titulo, "seleccione el estado de tratamiento");
    return;
  }
  if (duracion === "") {
    alert_bonita(
      "error",
      titulo,
      "ingrese hasta cuando tiene que realizar el tratamiento"
    );
    return;
  }
  if (id_medicamento_input === "x" || id_medicamento_input === "") {
    alert_bonita(
      "error",
      titulo,
      "Seleccione el medicamento para el tratamiento"
    );
    return;
  }
  if (hora_consumo === "") {
    alert_bonita("error", titulo, "ingrese hora que  debe tomar medicamento");
    return;
  }
  var variable =
    "id_atencion=" +
...
function select_Prueba_medica() {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/estructura/select_Prueba_medica.php";
  var titulo = localStorage.getItem("titulo");
  var variable = "";
  $.ajax({
    type: "POST",
...
function eliminar_detalle_tratamiento(id_detalle_tratamiento, id_tratamiento) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/php/eliminar_detalle_tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var variable =
...
function examen() {
  var dominio =
    localStorage.getItem("dominio") + "sistema/hospitilizacion/estructura/examen.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
  var variable = "id_atencion=" + id_atencion;
...
function eliminar_detalle_examen(id_det_examen, id_examen) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/php/eliminar_detalle_examen.php";
  var titulo = localStorage.getItem("titulo");
...
function guardar_examen() {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/php/guardar_examen.php";
  var titulo = localStorage.getItem("titulo");
  var variable =
    "id_atencion=" +
    id_atencion +
...
function Finalizar() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/php/update_atencion.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function select_id_tipo(id_tipo) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/hospitilizacion/estructura/select_tipo_atencion.php";
  var titulo = localStorage.getItem("titulo");
...
function tabla_vital_antencion(id_atencion) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/quirofano_enfermero/estructura/tabla_vital_antencion.php";
  var titulo = localStorage.getItem("titulo");
  var variable = "id_atencion=" + id_atencion;
  $.ajax({
    type: "POST",
