...
function tabla_paciente() {
    var  dominio=localStorage.getItem("dominio")+"sistema/emergencia_enfermero/estructura/tabla.php";
...
function vitales(parametro){
    var  dominio=localStorage.getItem("dominio")+"sistema/emergencia_enfermero/estructura/formulario_vital.php";
    var  titulo=localStorage.getItem("titulo");
...
var  dominio=localStorage.getItem("dominio")+"sistema/emergencia_enfermero/php/signos_vitales.php";
$.ajax({
    type: "POST",
    url: dominio,
    data: variable,
