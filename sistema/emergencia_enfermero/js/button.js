...
function tabla_alergia_paciente(cedula_paciente) {
  ...
  var dominio2 =
    ...
    "sistema/emergencia_enfermero/estructura/formulario_alergia.php";
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/alergias_paciente.php";
  $.ajax({
    type: "POST",
    url: dominio2,
    data: "",
...
function tabla_antecedentes_familiarC(cedula_paciente) {
  var dominio2 =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/formulario_antecedentes.php";
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/tabla_antecedentes_familiar.php";
  var titulo = localStorage.getItem("titulo");
...
function tabla_vital_antencion(id_atencion) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/tabla_vital_antencion.php";
  var titulo = localStorage.getItem("titulo");
...
function vital() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/php/signos_vitales.php";
...
function seguimiento_medicamento(id_atencion) {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/formulario_tratamiento.php";
  $.ajax({
    type: "POST",
    url: dominio,
    data: "",
...
function tratamiento(id_atencion) {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/tratamiento.php";
  $.ajax({
    type: "POST",
    url: dominio,
    data: variable,
...
function select_id_detalle_tratamiento(id_atencion) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/estructura/select_medicamento.php";
  $.ajax({
    type: "POST",
    url: dominio,
...
function almacenar_seguimiento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia_enfermero/php/almacenar_seguimiento.php";
  var id_atencion = $("#id_atencion").val();
  var donde = $("#donde").val();
