<div class="row">
  ...
  <div class="col-lg-6 col-sm-6 col-dm-6">
    <div class="form-floating mb-3">
      <input type="text" class="form-control" id="nombre_medico" name="nombre_medico" placeholder="namecom" onkeypress="return letra(event);" onkeyup="return limitar(event,this.value,120);" maxlength="120">
...
<div class="row mb-3">
  <div class="form-floating">
    <select class="form-select" id="id_especialidad" name="id_especialidad" aria-label="Floating label select example">
    </select>
...
<div class="row">
  <div class="col-lg-6 col-sm-6 col-dm-6">
<div class="form-floating mb-3">
  <input type="text" class="form-control" id="usuario_usuario" name="usuario_usuario" placeholder="name"  onkeyup="return limitar(event,this.value,120);" onchange="validar_usuario()">
