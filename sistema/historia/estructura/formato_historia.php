...
<table class="" style=" padding-bottom: 1mm;">
    <tr>
      <td class="td-25">
        <img src="<?= $nombreImagen ?>" alt="" srcset="" style="width: 180mm;
    height: 145px;">
      </td>
    </tr>
  </table>
  <table class="table table-bordered smallmega">
    <tr>
    <td   colspan="1">Cedula</td><td   colspan="2"><?=$cedula?></td>
        <td   colspan="2">Nombre Apellido</td><td  colspan="5"><?=$nombre_paciente?></td>
    </tr>
   <tr>
    <td class="td-max" colspan="1">Sexo</td>
    <td class="td-max" colspan="1"><?=$sexo_paciente?></td>
    <td class="td-max" colspan="1">Tipo de sangre</td>
    <td class="td-max" colspan="1"><?=$tipo_sangre?></td>
    <td class="td-max" colspan="2">Fecha de nacimiento</td>
    <td class="td-max" colspan="1"><?=$fecha_nacimiento?></td>
    <td class="td-max" colspan="1">Telefono</td>
    <td class="td-max" colspan="2"><?=$telefono_paciente?></td>
   </tr>
   <tr><td colspan="10"></td></tr>
  </table>
  <table class="table table-bordered smallmega"> 
  <tr>
<td colspan="5">Alergia</td>
 
<td colspan="5">Gravedad</td> 
</tr>
<tbody>
  <?php
  $html="";
  while ($row=$consultaAlergia->fetch()) {
    $html.='<tr> 
    <td colspan="5">'.$row["alergias"].'</td>
    <td colspan="5">'.$row["gravedad"].'</td> 
    </tr>
    ';
  }
  echo $html;
...
<td colspan="4">tratamiento recibido</td> 
...
<tbody>
  ...
  while ($row=$consultaAntecedentes->fetch()) {
    $html.='<tr> 
    <td colspan="3">'.$row["tipo_enfermedad"].'</td>
    <td colspan="4">'.$row["tratamiento_recibido"].'</td> 
    <td colspan="1">'.$row["estado_actual"].'</td> 
    <td colspan="2">'.$row["parentesco_familiar"].'</td> 
    </tr>
    ';
  }
  echo $html;
...
if ($consulta->rowCount()==0) {
  # code...
  $html.='  <tr class=" ">
    <td colspan="10"><strong>No hay Tratamiento de '.$descripcions.'</strong></td> 
  </tr>';
  $html.='</table> ';
  return $html;
}
...
while ($row=$consulta->fetch()) {
 $html.='<tr>
<td colspan="5">'.$row["tratamiento"].'</td>
<td colspan="5">'.$row["medicamento"].'</td>
</tr>'; 
}
  ...
  function examen($descripcions,$id_atencion)
 {
  ...
  if ($consulta->rowCount()==0) {
    ...
    <tr class="">
      ...
      <td colspan="10"><strong>No hay examen de '.$descripcions.'</strong></td> 
    </tr>
    </thead>
    ';
  ...
  $html.='<tr class=" "> 
  <td colspan="5">'.$row["descripcion_examen"].'</td> 
  <td colspan="5">'.$row["fecha_registrada"].'</td> 
...
function detalle_examen($descripcions,$id_examen)
{
  ...
  <thead class=" ">
    <tr>
      ...
      <td colspan="5"><strong>Prueba de '.$descripcions.'</strong></td> 
      <td colspan="5"><strong>Resultado</strong></td>  
    </tr>
  </thead>
  <tbody >
  ...
  $html.='<tr class=" "> 
  <td colspan="5">'.$row["prueba_medica"].'</td> 
  <td colspan="5">'.$row["valor"].'</td>  
  </tr>
  ';
  $i++;
  }
