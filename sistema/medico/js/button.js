...
function nuevo_btn_m() {
    ...
    $.ajax({
        type: "POST",
        url: dominio+"sistema/medico/estructura/formulario.php",
        data: "",
...
function id_especialidad(){
    ...
    $.ajax({
        type: "POST",
        url: dominio+"sistema/medico/estructura/id_especialidad.php",
        data: "",
        success: function (response) {
...
function almacenar() {
    ...
    $.ajax({
        type: "POST",
        url: dominio+"sistema/medico/php/almacenar.php",
        data: variable,
        success: function (response) {
            tabla_paciente()
