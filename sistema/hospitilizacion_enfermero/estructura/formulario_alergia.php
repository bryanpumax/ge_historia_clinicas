<?php
//
//  http://144.126.145.136:33016/sri/comprobantes/vouchers/emited?type=1&username=1720836400001&id=&password=Promes@s1997&taskmode=1&year=2023&month=5&day=31&captchakey=32d70a14d5a9d7971bb5b3fcc5b9fdc0&captchaurl=https://2captcha.com&download=1&archive=xml
...
<div class="row">
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
        ...
        <div class=" mt-3">
            ...
            <div class="col">
                <button type="button" class="btn btn-outline-primary" onclick="tabla_paciente()">Regresar</button>
            </div>
            <div class="col ">
