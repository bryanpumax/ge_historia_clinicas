...
function tabla_paciente() {
    var  dominio=localStorage.getItem("dominio")+"sistema/hospitilizacion_enfermero/estructura/tabla.php";
    var  titulo=localStorage.getItem("titulo");
   $(".titulo").html("Hospital");
...
function vitales(parametro){
    var  dominio=localStorage.getItem("dominio")+"sistema/hospitilizacion_enfermero/estructura/formulario_vital.php";
    var  titulo=localStorage.getItem("titulo");
    var variable="id_atencion="+parametro
    $(".nuevo_btn").addClass("d-none");
    $(".consulta").html("");
    $(".formulario").html("");
    $(".titulo").html("Hospital-Signos vitales de paciente seleccionado"); 
$.ajax({
    type: "POST",
    url: dominio,
    data: variable,
...
var  dominio=localStorage.getItem("dominio")+"sistema/hospitilizacion_enfermero/php/signos_vitales.php";
$.ajax({
    type: "POST",
    url: dominio,
    data: variable,
