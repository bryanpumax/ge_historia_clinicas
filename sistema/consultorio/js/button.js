...
function tabla_alergia_paciente(cedula_paciente) {
    $(".consulta").html(""); 
    var  dominio=localStorage.getItem("dominio")+"sistema/consultorio/estructura/alergias_paciente.php";
    var  titulo=localStorage.getItem("titulo"); 
    $(".titulo").html("Consulta-Alergia de paciente seleccionado"); 
    $.ajax({
        type: "POST",
        url: dominio,
...
function tabla_antecedentes_familiarC(cedula_paciente) { 
    var  dominio=localStorage.getItem("dominio")+"sistema/consultorio/estructura/tabla_antecedentes_familiar.php";
    var  titulo=localStorage.getItem("titulo");
    $(".titulo").html("Consulta-Antecedentes de paciente seleccionado"); 
    $.ajax({
        type: "POST",
        url: dominio,
        data: "cedula_paciente="+cedula_paciente, 
...
function formulario_medico(id_atencion) {
    ...
    $.ajax({
        type: "POST",
        url: dominio+"sistema/consultorio/estructura/formulario.php",
...
function generar_tbl_medicamento() {
    var dominio = localStorage.getItem("dominio") + "sistema/consultorio/estructura/generar_tbl_medicamento.php";
    var titulo = localStorage.getItem("titulo");
  ...
  function guardar_diagnostico() {
    var dominio = localStorage.getItem("dominio") + "sistema/consultorio/php/actualizar_atencion.php";
    var titulo = localStorage.getItem("titulo");
...
var dominio = localStorage.getItem("dominio") + "sistema/consultorio/estructura/tratamiento.php";
    var titulo = localStorage.getItem("titulo");
    var id_atencion = $("#id_atencion").val();
    ...
    examen()
      ...
      function guardar_tratamiento() {
       var dominio = localStorage.getItem("dominio") + "sistema/consultorio/php/tratamiento.php";
    var titulo = localStorage.getItem("titulo");
var id_atencion = $("#id_atencion").val();
 ...
 success: function (response) {
  ...
  $("#hora_consumo").val("");
    ...
    function select_Prueba_medica() {
        ...
        var dominio = localStorage.getItem("dominio") + "sistema/consultorio/estructura/select_Prueba_medica.php";
        var titulo = localStorage.getItem("titulo");
        var variable=""
        $.ajax({
            type: "POST",
      ...
      function eliminar_detalle_tratamiento(id_detalle_tratamiento,id_tratamiento){
        var dominio = localStorage.getItem("dominio") + "sistema/consultorio/php/eliminar_detalle_tratamiento.php";
        var titulo = localStorage.getItem("titulo");
      ...
      function examen() {
        var dominio = localStorage.getItem("dominio") + "sistema/consultorio/estructura/examen.php";
    var titulo = localStorage.getItem("titulo");
    var id_atencion = $("#id_atencion").val();
    var variable = "id_atencion=" + id_atencion  
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        function eliminar_detalle_examen(id_det_examen,id_examen){
          var dominio = localStorage.getItem("dominio") + "sistema/consultorio/php/eliminar_detalle_examen.php";
          var titulo = localStorage.getItem("titulo");
        ...
        function guardar_examen() {
          ...
          var dominio = localStorage.getItem("dominio") + "sistema/consultorio/php/guardar_examen.php";
          var titulo = localStorage.getItem("titulo");
        ...
        function Finalizar() {
          var dominio = localStorage.getItem("dominio") + "sistema/consultorio/php/update_atencion.php";
          var titulo = localStorage.getItem("titulo");
          var id_atencion = $("#id_atencion").val();
          ...
          function select_id_tipo(id_tipo) {
            var dominio = localStorage.getItem("dominio") + "sistema/consultorio/estructura/select_tipo_atencion.php";
            var titulo = localStorage.getItem("titulo");
