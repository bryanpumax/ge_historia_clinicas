...
function tabla_alergia_paciente(cedula_paciente) {
  ...
  var dominio =
    ...
    "sistema/emergencia/estructura/alergias_paciente.php";
  var titulo = localStorage.getItem("titulo");
  $(".titulo").html("Emergencia-Alergia de paciente seleccionado");
  $.ajax({
    type: "POST",
    url: dominio,
...
function tabla_antecedentes_familiarC(cedula_paciente) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/estructura/tabla_antecedentes_familiar.php";
  var titulo = localStorage.getItem("titulo");
  $(".titulo").html("Emergencia-Antecedentes de paciente seleccionado");
  $.ajax({
    type: "POST",
    url: dominio,
    data: "cedula_paciente=" + cedula_paciente,
...
function formulario_medico(id_atencion) {
  ...
  $.ajax({
    type: "POST",
    url: dominio + "sistema/emergencia/estructura/formulario.php",
...
function generar_tbl_medicamento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/estructura/generar_tbl_medicamento.php";
  var titulo = localStorage.getItem("titulo");
...
function guardar_diagnostico() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/php/actualizar_atencion.php";
  var titulo = localStorage.getItem("titulo");
...
function mostrar_tbl_tratamiento() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/estructura/tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function guardar_tratamiento() {
  var dominio =
    localStorage.getItem("dominio") + "sistema/emergencia/php/tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function select_Prueba_medica() {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/estructura/select_Prueba_medica.php";
  var titulo = localStorage.getItem("titulo");
  var variable = "";
  $.ajax({
    type: "POST",
...
function eliminar_detalle_tratamiento(id_detalle_tratamiento, id_tratamiento) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/php/eliminar_detalle_tratamiento.php";
  var titulo = localStorage.getItem("titulo");
  var variable =
...
function examen() {
  var dominio =
    localStorage.getItem("dominio") + "sistema/emergencia/estructura/examen.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
  var variable = "id_atencion=" + id_atencion;
...
function eliminar_detalle_examen(id_det_examen, id_examen) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/php/eliminar_detalle_examen.php";
  var titulo = localStorage.getItem("titulo");
...
function guardar_examen() {
  ...
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/php/guardar_examen.php";
  var titulo = localStorage.getItem("titulo");
  var variable =
    "id_atencion=" +
    id_atencion +
...
function Finalizar() {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/php/update_atencion.php";
  var titulo = localStorage.getItem("titulo");
  var id_atencion = $("#id_atencion").val();
...
function select_id_tipo(id_tipo) {
  var dominio =
    localStorage.getItem("dominio") +
    "sistema/emergencia/estructura/select_tipo_atencion.php";
  var titulo = localStorage.getItem("titulo");
